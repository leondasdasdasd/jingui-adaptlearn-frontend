export const routes = {
  ...
  studentEntry: (studentId = ':studentId') => `/adaptive-learning/student/${studentId}`,
  knowledgeLearning: (knowledgePointId = ':knowledgePointId') => `/adaptive-learning/knowledge/${knowledgePointId}/learn`,
  ...
  familyMonitor: (shareToken = ':shareToken') => `/adaptive-learning/family/${shareToken}`,
  teacherClasses: '/adaptive-learning/teacher/classes',
  teacherClassStudents: (classId = ':classId') => `/adaptive-learning/teacher/classes/${classId}/students`,
  teacherClassStudentHome: (classId = ':classId', studentId = ':studentId') => `/adaptive-learning/teacher/classes/${classId}/students/${studentId}/home`,
};
