 ...
 * @param root0.assessmentPolicyId
 */
export default function AssessmentMatrixTable({
  ...
  const domains = assessmentDomains(trans, assessmentPolicyId);
  const levels = assessmentLevels(trans, assessmentPolicyId);
...
AssessmentMatrixTable.propTypes = {
  ...
  assessmentPolicyId: PropTypes.string.isRequired,
