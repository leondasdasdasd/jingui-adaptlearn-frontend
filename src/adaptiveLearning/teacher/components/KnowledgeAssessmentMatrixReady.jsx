...
export default function KnowledgeAssessmentMatrixReady({
  ...
  useEffect(() => {
    if (applicableCells.some((cell) => cell.cellId === requestedCellId)) {
      setSelectedCellId(requestedCellId);
    }
  }, [applicableCells, requestedCellId]);
  ...
  return (
    ...
    >
      ...
      <AssessmentMatrixTable
        cells={matrix.cells}
        assessmentPolicyId={matrix.assessmentPolicyId}
