...
import { publishedVersionToTeacherContent } from "../domain/publishedVersionView";
    ...
    getLatestLessonVersion(lesson.id)
      .then((published) => {
        ...
        setAllContent(() => {
          ...
          const publishedView = publishedVersionToTeacherContent(published, {
            ...local,
            lessonId: lesson.id,
          });
          const next = hasNewerDraft
            ? {
                ...local,
