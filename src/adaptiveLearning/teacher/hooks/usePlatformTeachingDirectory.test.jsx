...
vi.mock("../data/platformTeachingDirectoryRepository", () => ({
  fetchPlatformCourseRoster: vi.fn(),
  fetchPlatformCourses: vi.fn(),
  fetchPlatformCurrentSemester: vi.fn(),
  fetchPlatformSubjects: vi.fn(),
}));
